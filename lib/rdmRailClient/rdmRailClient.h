...
class rdmRailClient: public JsonListenerGS {
    ...
    private:
        ...
        void replaceWord(char* input, size_t inputSize, const char* target, const char* replacement);
        ...
        bool getCrsCode(const char *callingList, const char *crsList, const char *viaSearchLocation, char *crs);
        bool split_location(const char* src, const char* joiner, char* left, char* right);
